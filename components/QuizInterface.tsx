  ...
  return (
    <div className="fixed inset-0 z-[60] bg-white flex flex-col animate-in slide-in-from-right-10 duration-500">
      ...
      <div className="bg-white border-b border-slate-100 p-6 flex justify-between items-center shadow-sm">
        ...
        <div className="flex items-center gap-2 bg-slate-900 text-white px-5 py-2.5 rounded-2xl shadow-xl font-mono">
          <Timer size={18} className={timeRemaining < 60 ? 'text-red-400 animate-pulse' : ''} />
        ...
        <div className="flex gap-4">
          {currentQuestion < questions.length - 1 ? (
            <button
              ...
              className="px-8 py-3 rounded-2xl bg-slate-900 text-white font-bold hover:bg-slate-800 shadow-xl transition-all flex items-center gap-2 active:scale-95"
            >
              Next
