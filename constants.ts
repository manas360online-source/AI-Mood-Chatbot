...
export const LOCALIZED_UI: Record<string, any> = {
  'en-IN': {
    ...
    welcome: "Hi there, I'm your MANAS360 support companion. I'm here 24/7. How can I support you today?",
    starters: [
  ...
  'hi-IN': {
    ...
    welcome: "नमस्ते, मैं आपका MANAS360 सहायता साथी हूं। मैं यहाँ 24/7 उपलब्ध हूं। आज मैं आपकी कैसे मदद कर सकता हूं?",
    starters: [
  ...
  'kn-IN': {
    ...
    welcome: "ನಮಸ್ಕಾರ, ನಾನು ನಿಮ್ಮ MANAS360 ಬೆಂಬಲ ಸಂಗಾತಿ. ನಾನು 24/7 ಇಲ್ಲಿದ್ದೇನೆ. ಇಂದು ನಾನು ನಿಮಗೆ ಹೇಗೆ ಸಹಾಯ ಮಾಡಬಹುದು?",
    starters: [
  ...
  'te-IN': {
    ...
    welcome: "నమస్కారం, నేను మీ MANAS360 మద్దతు భాగస్వామిని. నేను 24/7 ఇక్కడ ఉన్నాను. ఈరోజు నేను మీకు ఎలా సహాయపడగలను?",
    starters: [
  ...
  'ta-IN': {
    ...
    welcome: "வணக்கம், நான் உங்கள் MANAS360 ஆதரவு துணை. நான் 24/7 இங்கே இருக்கிறேன். இன்று நான் உங்களுக்கு எப்படி உதவ முடியும்?",
    starters: [
...
You are an empathetic, non-judgmental AI emotional support companion for MANAS360. 
...
export const WELCOME_MESSAGE: Message = {
  id: 'welcome-msg',
  role: Role.MODEL,
  content: "Hi there, I'm your MANAS360 support companion. I'm here 24/7. How can I support you today?",
  timestamp: Date.now(),
  status: 'read'
};
